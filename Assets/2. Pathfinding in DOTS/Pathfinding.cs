...
public class Pathfinding : MonoBehaviour {
	...
	private void Start() {
		...
		//This is just a test function to display time-taken to complete
		FunctionPeriodic.Create(() => {
			float startTime = Time.realtimeSinceStartup;

			// Make Multi-Threaded Jobs
			...
			//We got out of for, all jobs ra, now mark them complete and destroy them.
	...
	private struct FindPathJob : IJob {
		...
		// We're moving FindPath function contents inside here
		/* ------------------2. FindPath() function  -----------------------------
		...
		public void Execute() {
			...
			int2 gridSize = new int2(20, 20); // GRID SIZE 
